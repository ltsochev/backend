                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror rounded-0" name="password" value="{{ old('password') }}" required autocomplete="password" />
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
